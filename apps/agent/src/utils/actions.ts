import { ActionItem, ActionType, StateAnnotation } from '../types';
import { TaskService, LogService, ChatMessageService } from '../services/database';
import { AIMessage } from '@langchain/core/messages';

// Execute actions generated by the agents
export const executeActions = async (state: typeof StateAnnotation.State, actions: ActionItem[]): Promise<typeof StateAnnotation.State> => {
      ...
      switch (action.type) {
        ...
        case ActionType.AskQuestion:
          ...
          if (action.payload.content) {
            newState.messages.push(new AIMessage({
