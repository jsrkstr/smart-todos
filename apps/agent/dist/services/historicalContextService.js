...
exports.HistoricalContextService = void 0;
exports.createHistoricalContextService = createHistoricalContextService;
/**
...
class HistoricalContextService {
     ...
     */
    async loadHistoricalContext(userId) {
        const now = new Date();
        ...
        const [appActivity, notifications, taskStats, pomodoroStats, moodStats, streakStats, chatStats,] = await Promise.all([
     ...
     */
    async getAppActivity(userId, startOfToday, startOfWeek) {
        var _a;
        ...
        return {
            lastAppOpen: ((_a = logs[0]) === null || _a === void 0 ? void 0 : _a.createdAt) || null,
     ...
     */
    async getNotificationHistory(userId, startOfToday, startOfWeek) {
        var _a;
        ...
        const todayMessages = assistantMessages.filter((msg) => msg.createdAt >= startOfToday);
        ...
        return {
            ...
            lastSent: ((_a = assistantMessages[0]) === null || _a === void 0 ? void 0 : _a.createdAt) || null,
            byType,
        };
    }
    /**
     ...
     */
    async getTaskCompletionStats(userId, startOfToday, startOfWeek) {
     ...
     */
    async getPomodoroStats(userId, startOfToday) {
        var _a;
        ...
        return {
            ...
            lastCompleted: ((_a = pomodoros[0]) === null || _a === void 0 ? void 0 : _a.createdAt) || null,
        };
    }
    /**
     * Get mood statistics
     */
    async getMoodStats(userId, startOfWeek) {
    ...
    async getStreakStats(userId) {
        ...
        return {
            currentStreak: (dailyStreak === null || dailyStreak === void 0 ? void 0 : dailyStreak.count) || 0,
            longestStreak: (dailyStreak === null || dailyStreak === void 0 ? void 0 : dailyStreak.count) || 0, // This should be tracked separately in the future
        };
    }
    /**
     * Get chat communication statistics
     */
    async getChatStats(userId, startOfToday) {
        ...
        const avgLength = recentAssistantMessages.length > 0
            ? recentAssistantMessages.reduce((sum, msg) => sum + msg.content.length, 0) / recentAssistantMessages.length
            : 200;
        const preferredLength = avgLength < 150 ? 'short' : avgLength < 400 ? 'medium' : 'detailed';
        return {
            lastUserMessage: (lastUserMessage === null || lastUserMessage === void 0 ? void 0 : lastUserMessage.createdAt) || null,
            messagesExchangedToday: userMessages.length,
            preferredLength: preferredLength,
        };
    }
}
exports.HistoricalContextService = HistoricalContextService;
/**
 * Create and export singleton instance
 */
function createHistoricalContextService(prisma) {
